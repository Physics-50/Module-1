...
fig1 = figure(); % create a new figure window
...
print -r600 -djpeg static-friction-plot-basic % save the figure as "static-friciton-plot-basic.jpg" 
                                              % using a resolution of 600 dots per inch (high resolution)

%% plot the data -- improved version, considering "salience" & "simplicity"
fig2 = figure(); % create a new figure window
...
print -r600 -djpeg static-friction-plot-improved % save the figure as "static-friciton-plot-improved.jpg" 
                                                 % using a resolution of 600 dots per inch (high resolution)