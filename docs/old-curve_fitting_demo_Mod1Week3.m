...
xlabel("mass added to container [g]","FontSize",14); % add x and y axis titles
ylabel("coefficient of static friction","FontSize",14);
...
set(ax,'XTick',[0, 100, 200, 300]); % set the x-tick locations manually (reduce number of ticks for "simplicity")
set(ax,'YTick',[0.5, 0.55, 0.6]); % set the y-tick locations manually (reduce number of ticks for "simplicity")
